...
// Admins can always delete. Non-admins can delete if they own the request,
// participated in the conversation, can chat on it, or are currently assigned
// to the ticket.
if (!$is_admin && !$isRequester && !$isCurrentAssignee && !$hasSentInConversation && !$canChat) {
    http_response_code(403);
