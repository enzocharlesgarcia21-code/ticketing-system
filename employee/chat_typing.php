...
$canChat = ticket_user_can_chat($ticket, $currentUserId, $userContext);
$isRequester = ticket_user_matches_requester($ticket, $currentUserId, $userContext);
$isSalesManager = ticket_user_is_sales_manager_for_ticket($ticket, $userContext);

if (!$canChat && !$isRequester && !$isSalesManager) {
    http_response_code(403);
